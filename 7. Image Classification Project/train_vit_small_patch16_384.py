...
def train(data_dir, model_dir, args):
    ...
    # ).to(device)
    model = timm.create_model("vit_small_patch16_384", pretrained=True, num_classes=18)
...
if __name__ == '__main__':
    ...
    Token = 'xoxb-3171520504785-3144326697895-4e0I3Mu9UTf6cwvoc1A696nv' # 자신의 Token 입력
    str2 = f'Training complete in {(time_elapsed // 60) // 60:.0f}h {(time_elapsed // 60) % 60 :.0f}m {time_elapsed % 60:.0f}s'
    str1_title = f'Best val Acc: {best_val_acc:4f} at epoch {best_epoch}.'
    attach_dict = {
        'color' : '#ff0000',
    ...
    notice_message(Token, "#general", str2, attach_list)
